...
function GraphvizDot(document) {
  if (this.constructor != GraphvizDot) {
    return new GraphvizDot(document);
  }
...
GraphvizDot.prototype._classDiagram = function(diagram) {
  return util.format('bgcolor="transparent";node [shape="record",fontname="Ubuntu Mono",fontsize="11",style="filled",fillcolor="#ffffff"];edge [arrowhead="none",arrowtail="none",fontname="Ubuntu Mono",fontsize="11"];%s%s', this._classes(diagram.classes), this._links(diagram.links));
};
