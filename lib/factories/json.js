...
var Variable = require('../shared/variable');
...
JSONFactory.prototype.set = function(data, value) {
  this.refs[JSON.stringify(data)] = value;
};

JSONFactory.prototype.get = function(data) {
  return this.refs[JSON.stringify(data)];
};

JSONFactory.prototype.has = function(data) {
